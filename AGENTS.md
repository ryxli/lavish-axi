...
- Human-authored PRs to `main` must go through [`no-mistakes`](https://github.com/ryxli/no-mistakes); CI enforces a deterministic signature in the PR body. See CONTRIBUTING.md.
