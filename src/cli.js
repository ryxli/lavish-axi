...
const COMMAND_HELP = {
  ...
  new: `Usage: lavish-axi new [--template <name>] [output-path]\n\nScaffold a new HTML artifact from a built-in template (default template: firstmate). The template is written to .lavish/<name>.html in the current directory by default, or to the optional output-path when provided. The output directory is created automatically.\n\nAvailable templates:\n  firstmate   Naval dark design with inline CSS (no CDN). Includes a hero block, verdict bar, cards, a comparison table, a decision form, a code block, and annotatable action buttons. All lavish interaction patterns are pre-wired. Compatible with claude.ai Artifact strict CSP.\n\nExamples:\n  lavish-axi new\n  lavish-axi new --template firstmate\n  lavish-axi new --template firstmate docs/review.html\n`,
